...
class _EventsScreenState extends ConsumerState<EventsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        child: Column(
          ...
          Material(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  // Balancing spacer to keep NIHUB logo centered
                  ...
                  const Spacer(),
                  // Exit/Logout button moved to the right
                  IconButton(
                    icon: const Icon(Icons.logout, color: AppColors.textSecondary, size: 26),
                    onPressed: () async {
            ...
            child: eventsAsync.when(
              data: (events) {
                final filtered = events.where((e) =>
                    ...
                    e.description.toLowerCase().contains(_query)).toList();
                        ...
                        ...filtered.asMap().entries.map((entry) {
                          ...
                          return Padding(
                            ...
                            child: EventCard(
                              event: event,
                              index: i,
                              onTap: () => context.push('/events/${event.code}/scan'),
                              onDelete: () => ref.read(eventsProvider.notifier).deleteCourse(event.code),
                              onDownload: () => _downloadSpreadsheet(event.code),
                            ),
                          );
                        }),
      ...
      // Create Event FAB - preserved position from Flutter
  ...
  Future<void> _downloadSpreadsheet(String code) async {
    try {
      ...
      await ref.read(eventsProvider.notifier).downloadSpreadsheet(code, savePath);
